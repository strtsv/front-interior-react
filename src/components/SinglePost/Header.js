    ...
    return (
      <header className="section page-header">
        ...
        <div className="rd-navbar-wrap">
          <nav
            className="rd-navbar rd-navbar-modern rd-navbar-original rd-navbar-static rd-navbar--is-stuck"
          ...
          >
            ...
            <div className="rd-navbar-main-outer">
              <div className="rd-navbar-main">
                ...
                <div className="rd-navbar-main-element">
                  <div className="rd-navbar-nav-wrap toggle-original-elements">
                    <ul className="rd-navbar-nav">
                      ...
                      <li className="rd-nav-item">
                        <a className="rd-nav-link" href="single-post.html">
                          Single Post
                        </a>
                      </li>
                      <li className="rd-nav-item">
                ...
                <div className="rd-navbar-aside-outer rd-navbar-collapse rd-navbar-phone-wrap">
                  <div className="rd-navbar-aside">
                    <div className="rd-navbar-phone">
                      <span>Call Us:</span>
                      <a className="link-gray-500" href="tel:#">
                        1 800 777 5555
                      </a>
                    </div>
                  </div>
